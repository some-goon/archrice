...
# Aliases:
[ -x "$(command -v nvim)" ] && alias vim="nvim" vimdiff="nvim -d" # Use nvim instead of vim if possible
alias sudo='doas'
alias pacman='paru --bottomup'
...
alias gamerun='mangohud gamemoderun'
alias subdl="osd"
